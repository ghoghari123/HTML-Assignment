...
function Home() {
  return (
    <div className='container m-0 p-0'>
      ...
      <div className="navbar flex justify-between py-10 px-10">
        <div className="logo color-white">
          <h1 className='text-4xl mx-5 w-20 bg-gradient-to-r from-cyan-200 to-blue-600 bg-clip-text text-transparent'>HG.</h1>
        </div>
        <div className="actions flex gap-20 mx-25 font-light">
          <div className="nav-links ">
            <ul className='flex text-ixl gap-10 cursor-pointer font-normal'>
      ...
      {/*========================== HERO SECTION START ========================================== */}
      <div className="hero-section h-100 mx-5 mt-30 p-10 flex justify-between">
        <div className="details flex flex-col gap-10">
          <h2 className='text-6xl'>Hemanshi Ghoghari</h2>
          ...
          <div className="hero-btn flex gap-5 h-10">
